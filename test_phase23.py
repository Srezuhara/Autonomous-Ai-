...
try:
    ...
    # Before: the planned file is on the never-generated list.
    _rr_before = Documenter.__new__(Documenter)._missing_files(
        _rr_arch, list(_rr_written), _rr_root
    )
    check("without registration, a planned requirements.txt reads as never generated",
          [p for p, _ in _rr_before] == ["requirements.txt"], _rr_before)
